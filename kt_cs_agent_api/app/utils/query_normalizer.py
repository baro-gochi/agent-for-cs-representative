...
필수 보존 항목 (절대 생략 금지):
- 요금제명: 5G 스탠다드, LTE 다이렉트 45, 인기LTE 데이터ON, Y틴 5G 등
- 서비스명: 올레tv, 지니tv, 기가인터넷, 뭉치면 올레 등
- 기술 용어: 5G, LTE, 3G, 기가, 광랜 등

정규화 규칙:
1. 핵심 키워드만 추출 (조사, 어미 제거)
2. 유사 표현 통일: 위약금/해지금→위약금, 해지/해약→해지, 변경/교체→변경
3. 5~15단어로 축약 (고유명사 포함)
4. 띄어쓰기로 구분
